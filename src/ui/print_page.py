...
class PrintPage(QWidget):
    ...
    def validate_sn(self, sn):
        ...
        sn = re.sub(r'[\s\W\u200b\ufeff]+$', '', sn) # 去除尾部所有空格和非词字符，包括 BOM
        sn = sn.strip() 
    ...
    def print_label(self):
        ...
        else: QMessageBox.critical(self,"失败", msg)from PyQt5.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QLabel, QLineEdit, 
                             QListWidget, QPushButton, QComboBox, QDateEdit, QGroupBox,
                             QMessageBox, QTableWidget, QTableWidgetItem, QHeaderView,
                             QAbstractItemView, QGridLayout)
from PyQt5.QtCore import QDate, Qt
